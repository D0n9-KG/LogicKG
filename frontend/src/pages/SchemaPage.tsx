...
const RULE_HELP_SECTIONS: RuleHelpSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { key: 'phase1_claim_batch_size', desc: 'Claim 批量抽取时每批最多包含多少个 chunk。' },
      { key: 'phase1_claim_batch_chars_max', desc: 'Claim 批量抽取时每批总字符数上限，让短 chunk 可以同批更多。' },
...
RULE_HELP_MAP.phase1_grounding_mode = '要点支持判定模式：lexical（纯规则）/ hybrid（规则+LLM）/ llm（全量LLM）。'
...
PROMPT_HELP_MAP.phase1_grounding_judge_system = {
  desc: '证据复核裁判系统提示词：定义要点与证据分块的支持关系判定规则。',
}
PROMPT_HELP_MAP.phase1_grounding_judge_user_template = {
  desc: '证据复核裁判用户模板：注入要点与证据分块的批次输入，返回支持标签与分数。',
...
export default function SchemaPage({ jumpTarget, jumpFocusKey, jumpNonce }: SchemaPageProps = {}) {
  ...
  function applyRulesJson() {
    ...
    try {
      ...
      if (!parsed || typeof parsed !== 'object' || Array.isArray(parsed)) {
        setRulesJsonError('规则 JSON 必须是对象')
        return
      }
      const next = clone(schema)
  ...
  function applyPromptsJson() {
    ...
    try {
      ...
      if (!parsed || typeof parsed !== 'object' || Array.isArray(parsed)) {
        setPromptsJsonError('提示词 JSON 必须是对象')
        return
      }
      const next = clone(schema)
      const out: Record<string, string> = {}
  ...
  return (
    <div className="page">
      <div className="pageHeader">
        <div>
          <h2 className="pageTitle">抽取规则（可配置）</h2>
          <div className="pageSubtitle">在默认配置基础上自定义：逻辑链步骤、要点类型、数量区间与规则（对未来重建生效）</div>
        </div>
        <div className="pageActions">
          ...
          >
            ...
            <option value="software">软件论文</option>
            <option value="theoretical">理论论文</option>
            <option value="case_study">案例论文</option>
          </select>
          <button
            className="btn"
            disabled={busy}
      ...
      {!schema ? (
        ...
        <div className="stack">
          <div className="panel">
            ...
            <div className="panelBody">
              ...
              <div className="hint" style={{ marginTop: 10 }}>
                提示：抽取规则变更只影响未来的“重建/替换/新导入”。已入库论文的展示会按其记录的 schema_version 渲染。
              </div>
          ...
          <div className="panel">
            <div className="panelHeader">
              <div className="panelTitle">逻辑节点（逻辑链）</div>
            </div>
            <div className="panelBody">
          ...
          <div className="panel">
            <div className="panelHeader">
              <div className="panelTitle">要点类型</div>
            </div>
            <div className="panelBody">
              <div className="itemCard" style={{ marginBottom: 14 }}>
          ...
          <div className="panel">
            <div className="panelHeader">
              <div className="panelTitle">规则</div>
            </div>
            <div className="panelBody">
              ...
              <div className="row" style={{ marginTop: 10 }}>
                ...
                <div className="pill" style={{ gap: 10 }}>
                  <RuleMeta ruleKey="phase1_claim_batch_size" label="phase1_claim_batch_size" />
                  <input
                    className="input"
                    style={{ width: 110 }}
                    type="number"
                    value={intOr((schema.rules as Record<string, unknown>)?.phase1_claim_batch_size, 6)}
                    onChange={(e) => updateRule('phase1_claim_batch_size', intOr(e.target.value, 6))}
                  />
                </div>
                <div className="pill" style={{ gap: 10 }}>
                  <RuleMeta ruleKey="phase1_claim_batch_chars_max" label="phase1_claim_batch_chars_max" />
                  <input
                    className="input"
                    style={{ width: 130 }}
                    type="number"
                    value={intOr((schema.rules as Record<string, unknown>)?.phase1_claim_batch_chars_max, 9600)}
                    onChange={(e) => updateRule('phase1_claim_batch_chars_max', intOr(e.target.value, 9600))}
                  />
                </div>
                <div className="pill" style={{ gap: 10 }}>
                  ...
                  <input
                    ...
                    style={{ width: 120 }}
                    type="number"
                    value={intOr((schema.rules as Record<string, unknown>)?.phase1_chunk_chars_max, 2200)}
                    onChange={(e) => updateRule('phase1_chunk_chars_max', intOr(e.target.value, 2200))}
                  />
                </div>
                <div className="pill" style={{ gap: 10 }}>
              ...
              <details className="itemCard" style={{ marginBottom: 10 }}>
                <summary style={{ cursor: 'pointer', fontWeight: 600 }}>高级规则（词表 / 证据复核 / 引用）</summary>
                <div style={{ marginTop: 10 }}>
              <div className="row" style={{ marginTop: 10 }}>
                <div className="pill" style={{ gap: 10, minWidth: 560 }}>
              ...
              <div id="schema-rules-json" className={`itemCard${jumpFlash === 'rules' ? ' configJumpFlash' : ''}`} style={{ marginTop: 12 }}>
                <div className="split">
                  <div className="itemTitle">规则 JSON（高级，支持任意键）</div>
                  <button className="btn btnSmall" disabled={busy} onClick={applyRulesJson}>
                    应用 JSON
                  </button>
                </div>
                <div className="hint" style={{ marginTop: 6 }}>
                  这里可编辑完整规则对象，覆盖页面未显式展示的任何规则项。
                </div>
          ...
          <div className="panel">
            <div className="panelHeader">
              <div className="panelTitle">提示词</div>
            </div>
            <div className="panelBody">
              <div className="hint">
                ...
                <br />
                说明：提示词里仍使用 <code>claims</code> 字段名（系统内部 JSON 键），但前端展示称为“要点”。
              </div>
              ...
              <div className="list" style={{ marginTop: 12 }}>
                ...
                <div className="itemCard">
                  <div className="split">
                    <div className="itemTitle">逻辑与要点抽取：系统提示词</div>
                ...
                <div className="itemCard">
                  <div className="split">
                    <div className="itemTitle">逻辑与要点抽取：用户模板</div>
                    <div className="row" style={{ gap: 8 }}>
                ...
                <div className="itemCard">
                  <div className="split">
                    <div className="itemTitle">证据选择：系统提示词</div>
                    <div className="row" style={{ gap: 8 }}>
                ...
                <div className="itemCard">
                  <div className="split">
                    <div className="itemTitle">证据选择：用户模板</div>
                    <div className="row" style={{ gap: 8 }}>
                ...
                <details className="itemCard" style={{ padding: 10 }}>
                  <summary style={{ cursor: 'pointer', fontWeight: 600 }}>语义裁判提示词（证据复核 + 冲突判定）</summary>
                  <div className="list" style={{ marginTop: 10 }}>
                    <div className="itemCard">
                      <div className="split">
                        <div className="itemTitle">证据复核裁判：系统提示词</div>
                        <div className="row" style={{ gap: 8 }}>
                    ...
                    <div className="itemCard">
                      <div className="split">
                        <div className="itemTitle">证据复核裁判：用户模板</div>
                        <div className="row" style={{ gap: 8 }}>
                ...
                <div className="itemCard">
                  <div className="split">
                    <div className="itemTitle">逻辑证据绑定：系统提示词</div>
                    <div className="row" style={{ gap: 8 }}>
                ...
                <div className="itemCard">
                  <div className="split">
                    <div className="itemTitle">逻辑证据绑定：用户模板</div>
                    <div className="row" style={{ gap: 8 }}>
                ...
                <div className="itemCard">
                  <div className="split">
                    <div className="itemTitle">分块要点抽取：系统提示词</div>
                    <div className="row" style={{ gap: 8 }}>
                ...
                <div className="itemCard">
                  <div className="split">
                    <div className="itemTitle">分块要点抽取：用户模板</div>
                    <div className="row" style={{ gap: 8 }}>
                ...
                <details className="itemCard" style={{ padding: 10 }}>
                  <summary style={{ cursor: 'pointer', fontWeight: 600 }}>引用目的提示词</summary>
                  <div className="list" style={{ marginTop: 10 }}>
                <div className="itemCard">
                  <div className="split">
                    <div className="itemTitle">引用目的分类（批量）：系统提示词</div>
                    <div className="row" style={{ gap: 8 }}>
                ...
                <div className="itemCard">
                  <div className="split">
                    <div className="itemTitle">引用目的分类（批量）：用户模板</div>
                    <div className="row" style={{ gap: 8 }}>
                ...
                <details className="itemCard" style={{ padding: 10 }}>
                  <summary style={{ cursor: 'pointer', fontWeight: 600 }}>参考文献补抽</summary>
                  <div className="list" style={{ marginTop: 10 }}>
                    <div className="itemCard">
                      <div className="split">
                        <div className="itemTitle">参考文献补抽：系统提示词</div>
                        <div className="row" style={{ gap: 8 }}>
                    ...
                    <div className="itemCard">
                      <div className="split">
                        <div className="itemTitle">参考文献补抽：用户模板</div>
                        <div className="row" style={{ gap: 8 }}>
              ...
              <div id="schema-prompts-json" className={`itemCard${jumpFlash === 'prompts' ? ' configJumpFlash' : ''}`} style={{ marginTop: 12 }}>
                <div className="split">
                  <div className="itemTitle">提示词 JSON（高级，支持任意键）</div>
                  <button className="btn btnSmall" disabled={busy} onClick={applyPromptsJson}>
                    应用 JSON
                  </button>
                </div>
                <div className="hint" style={{ marginTop: 6 }}>
                  这里可编辑完整提示词对象，支持新增任意提示词键（后端按键读取）。
                </div>
