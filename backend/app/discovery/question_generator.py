...
def _template_candidate(gap: dict, *, index: int, variant: int) -> dict:
    ...
    return {
        ...
        "feasibility": "Feasible with current pipeline by reusing extracted claims, proposition relations, and evidence chunks as the experimental design substrate.",
        ...
        "source_proposition_ids": list(gap.get("source_proposition_ids") or []),
